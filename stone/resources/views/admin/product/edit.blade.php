    ...
    <div class="row p-3 ">
      ...
      <div class="col-sm-12 bg-light mb-4">
        ...
        <div class="p-4 ">
              ...
              <form class="w-50" action="{{route('admin.product.update',$product_data->id)}}" method="post" id="customer_create"  enctype="multipart/form-data" >
              ...
              <div class="form-group">
                <label for="exampleInputEmail1">Select Category</label>
                  ...
                  <select name="category_id" class="form-control"  id="">
                    ...
                    <option value="{{$category->id}}"<?php echo  ($category->id == $product_data->category_id )?'selected':'';  ?> > {{$category->name}}</option>
                    @endforeach
              ...
              <div class="form-group">
               ...
               <textarea name="description" class="form-control" cols="30" rows="5">{!! $product_data->description !!}</textarea>
               <span class="text-danger error-text  description_error "></span>
              </div>
              <div class="form-group">
                <label for="exampleInputEmail1">Specifications</label>
              
               <textarea name="specifications" id="specifications" class="form-control" cols="30" rows="5">{!! $product_data->specifications !!}</textarea>
              ...
              <img src="{{APP_PATH.PRODUCT_IMAGE.$product_data->image}}" alt="" height="100">
              ...
              @foreach($product_data->gallery_images as $images)
              <img src="{{APP_PATH.PRODUCT_IMAGE.$images}}" alt="" height="100">
              @endforeach
              ...
              <input type="text" name="sale_price" class="form-control" value="{{ $product_data->sale_price }}">
              ...
              <input type="text" name="sku" value="{{ $product_data->sku }}"  class="form-control">
              ...
              <div class="form-group">
                ...
                <select name="disappear_after_order" class="form-control" id="">
                  ...
                  <option value="0" <?php echo ($product_data->disappear_after_order == 0) ? 'selected' :''; ?> >No</option>
                  <option value="1" <?php echo ($product_data->disappear_after_order == 1) ? 'selected' :''; ?> >Yes</option>
                </select>
