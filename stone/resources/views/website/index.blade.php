...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <section class="home-category-section">
      <div class="container">
            <h2 class="text-center">EXPERIENCE THE POWER & BENEFITS OF OUR GEMSTONES</h2>  
              <div class="home-category-block">
                      <div class="row">
                        
                      
                        <div class="col-12 col-md-6 col-lg-4 text-center category-list" >
                          <a href="" class="home-category-item-content">
                          <figure class="img-hover-zoom" >
                            <img src="{{asset('images/first.png')}}" width="358" height="200" class="border">
                          </figure>
                          </a>
                          <div class="middle">
                        ...
                        <div class="col-12 col-md-6 col-lg-4 text-center category-list" >
                          <a href="" class="home-category-item-content">
                          <figure class="img-hover-zoom" >
                            <img src="{{asset('images/second.png')}}" width="358" height="200" class="border">
                          </figure>
                          </a>
                          <div class="middle">
                            <div class="text">test</div>
                        ...
                        <div class="col-12 col-md-6 col-lg-4 text-center category-list" >
                          <a href="" class="home-category-item-content">
                          <figure class="img-hover-zoom" >
                            <img src="{{asset('images/third.png')}}" width="358" height="200" class="border">
                          </figure>
                          </a>
                          <div class="middle">
                            <div class="text">test</div>
                        ...
                        <div class="col-12 col-md-6 col-lg-4 text-center category-list" >
                          <a href="" class="home-category-item-content">
                          <figure class="img-hover-zoom" >
                            <img src="{{asset('images/forth.png')}}" width="358" height="200" class="border">
                          </figure>
                          </a>
                          <div class="middle">
                            <div class="text">test</div>
                        ...
                        <div class="col-12 col-md-6 col-lg-4 text-center category-list" >
                          <a href="" class="home-category-item-content">
                          <figure class="img-hover-zoom" >
                            <img src="{{asset('images/fifth.png')}}" width="358" height="200" class="border">
                          </figure>
                          </a>
                          <div class="middle">
                            <div class="text">test</div>
