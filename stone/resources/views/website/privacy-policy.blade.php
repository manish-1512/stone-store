...
@section('content')
  ...
  <div class="page-banner">
       ...
       <h2 class="banner-text title-font"> Privacy Policy </h2>
  </div>

    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="{{route('home')}}">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">privacy-policy</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section border-bottom" data-aos="fade">
      <div class="container">
        <h2 class="text-center about title-font mb-4">  Privacy Policy</h2>
          @for($i=1;$i<8;$i++)
